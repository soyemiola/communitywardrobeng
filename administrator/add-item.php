                    ...
                    <div class="page-body">
                      <div class="card">
                        <div class="card-header">
                          <h5>Add Item Record</h5>
                          <div class="card-header-right">
                              <ul class="list-unstyled card-option">
                                    <li><a href="items.php"><i class="feather icon-list" title="recipients record"></i>Record List</a></li>
                              </ul>
                            </div>
                        </div>
                        <div class="card-block">
                          <div class="row">
                            <div class="col-xs-12 col-md-6">
                              ...
                              <form class="mt-1" method="post" action="../assets/php/proc_items.php">
                                <div class="boxx">
                                  <h6>Item Name</h6>
                                  <div class="form-group input-group mb-3">
                                    <input type="text" class="form-control shadow-none" name="name" required placeholder="">
                                  </div>

                                  <h6>Item Count</h6>
                                  <div class="form-group input-group mb-3">
                                    <input type="text" class="form-control shadow-none" name="count" required placeholder="0">
                                  </div>
