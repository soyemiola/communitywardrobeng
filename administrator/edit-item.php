<?php 
  ...
  $rec = $e->edit_item(base64_decode($_GET['id']));
                            ...
                            <div class="col-xs-12 col-md-6">
                              ...
                              foreach ($rec as $key => $value) {
                                ...
                                <div class="boxx">
                                  ...
                                  <h6>Item Count</h6>
                                  <div class="form-group input-group mb-3">
                                    <input type="text" class="form-control shadow-none" name="count" value="<?php echo $value['counts'] ?>" required placeholder="0">
                                  </div>

                                  <div class="form-group mt-3">
                                    <input type="hidden" name="robot">
                                    <input type="hidden" name="update" value="1">
                                    <a href="items.php" class="btn btn-light btn-sm">Back</a>
